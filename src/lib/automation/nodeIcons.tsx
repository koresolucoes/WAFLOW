...
const InteractiveIcon = ({className}: {className?: string}) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12V8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h4"/><path d="M18 22a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="m18 16-2-2"/><path d="m22 20 2 2"/><path d="m14 20-2 2"/></svg>;
const ClickIcon = ({className}: {className?: string}) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12Z"/><path d="M13.1 12.4 11 15l-1.45-1.1-1.3-2.9-2.3-2.25 2.8-.2L11 6l2.15 2.1.2 2.8Z"/><path d="m18 11 1-1-1-1"/><path d="m15 8-1-1-1 1"/></svg>;

// Default Icon
const DefaultIcon = ({className}: {className?: string}) => <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20V10"/><path d="M12 10a2 2 0 1 0-4 0v4a2 2 0 1 0 4 0Z"/><path d="M12 10a2 2 0 1 1 4 0v4a2 2 0 1 1-4 0Z"/><path d="m15 5-3 3-3-3"/><path d="M6.1 6.1A2 2 0 1 0 4 8h2"/><path d="M17.9 6.1A2 2 0 1 1 20 8h-2"/></svg>;

export const nodeIcons: Record<string, React.FC<{className?: string}>> = {
    // Triggers
    'message_received_with_keyword': MessageIcon,
    'button_clicked': ClickIcon,
    'new_contact': UserPlusIcon,
    'new_contact_with_tag': TagIcon,
    'webhook_received': WEBHOOK_ICON,
    // Actions
    'send_template': FILE_TEXT_ICON,
    'send_text_message': SEND_ICON,
    'add_tag': ({className}) => <div className="relative"><TagIcon className={className}/><PLUS_ICON className="absolute -bottom-1 -right-1 w-3 h-3 bg-slate-800 text-green-400"/></div>,
    'remove_tag': ({className}) => <div className="relative"><TagIcon className={className}/><TRASH_ICON className="absolute -bottom-1 -right-1 w-3 h-3 bg-slate-800 text-red-400"/></div>,
    'set_custom_field': CustomFieldIcon,
    'send_media': MediaIcon,
    'send_interactive_message': InteractiveIcon,
    'send_webhook': WEBHOOK_ICON,
    // Logic
